 ...
 *
 * Repository: https://github.com/gunjanshamani-hub/Jenkins-Pipeline.git

 * Class Name: heeloworld (to execute heeloworld.java)
 *
 * NOTE: This version assumes heeloworld.java is located inside a 'src' subdirectory.
 */
pipeline {
    agent any

    environment {
        CLASS_NAME = 'heeloworld'
        GIT_REPO ='https://github.com/gunjanshamani-hub/Jenkins-Pipeline.git'
